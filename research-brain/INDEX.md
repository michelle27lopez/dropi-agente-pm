# Research Brain — Índice

> Base de conocimiento viva de Dropi · Supplier Success.
> Consultable conversacionalmente. Sincronizada con Supabase (tabla `research_documents`).
...
## Vacíos de conocimiento detectados (áreas sin research)

- Suppliers (proveedores): **research directo con proveedores reales** — RB-004 documenta segmentos y journey con hechos confirmados, pero no hay entrevistas ni personas cualitativas del lado supplier
- Reglas de descenso/pérdida de categoría de proveedor (no documentadas en ningún lado, ver RB-004 §3)
- Segmento Premium Exclusivo / contrato propio: casi sin documentación operativa más allá del nombre (ver RB-004 §3)
- Compradores / consumidores finales
- Experiencia de negociación de productos
- Combos: comportamiento y decisión de compra
- Setboard / priorización de oportunidades
