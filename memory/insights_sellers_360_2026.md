# 🧠 Memoria Estratégica: Insights 360° Célula Seller Success (2026)

> Documento de referencia de inteligencia de negocios para toma de decisiones, priorización de roadmap y presentación de Showcase con CPO (María Ossa).
...
## 🧭 Pilar 4: Bifurcación del Onboarding (34% Fríos vs 22,8% VIP de Entrada)
* **Hallazgo:** En UserPilot, 34,0% declara "Aún no gestiono pedidos" (novatos fríos) y 22,8% declara "Vender >300 pedidos/mes" al registrarse.
* **Decisión:** Implementar flujo bifurcado en Page Pilot:
  * *Ruta Express (Sellers >300 ord):* Integración API rápida + Carga bancaria + KAM asignado.
  * *Ruta Guiada (Novatos 0 ord):* Muestras 1-Clic + FAQs in-app + Catálogo verificado.

---

## 📱 Pilar 5: Operación Móvil (27,7% Tráfico)
* **Hallazgo:** 27,7% del tráfico de sellers en UserPilot proviene de móviles (19.3% Android + 8.4% iOS).
* **Decisión:** Priorizar diseño Mobile-First en herramientas de alta frecuencia (Wrapped, Saldos, Muestras 1-Clic).

---

## 🔍 Aspectos Clave Adicionales para la Estrategia (Cruciales)

1. **Efecto Estacional de Productos (Riesgo de Dependencia por Temporada):**
   - Productos estrella como *Fundas Navideñas Para Puertas* (Top en Seller Sandry Rodelo 671121) u *Oxímetros* sufren picos de temporada alta seguidos de caídas drásticas.
   - **Recomendación:** Sugerir productos de rotación continua (Belleza, Cuidado Personal, Hogar) a los sellers Pareto antes de que sus campañas de temporada entren en declive.

2. **TTV Neto vs TTV Bruto (Latencia de Entrega):**
   - La mediana de TTV Bruto (días a 1ª orden creada) es **7.4 días**, pero la mediana de TTV Neto (días a 1ª orden entregada) es **16.0 días** (brecha de +8.6 días).
   - **Recomendación:** La transportadora y la logística de primer envío son el mayor freno para convertir la activación bruta en activación neta.

3. **Retención a 30 Días (69.38% vs Meta 75.0%):**
   - Cruzar el umbral de **100 órdenes acumuladas reduce el churn en un 82%** (según el Playbook de Leyendas v7.0). Todo el foco de incentivos debe centrarse en empujar a los sellers del Nivel 1 (Bienvenido) al Nivel 2 (Explorador - 101 órdenes).
