...
export default function LoginPage() {
  ...
  const inputClass =
    "w-full rounded-lg border border-border bg-background px-3.5 py-2.5 text-sm text-foreground outline-none focus:border-dropi";

  return (
    <main className="flex min-h-screen items-center justify-center bg-background p-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-xl font-bold text-foreground">Metrics Lab</h1>
          ...
          {mode === "password" && (
            <form onSubmit={handlePassword} className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-1 w-full rounded-lg bg-dropi py-2.5 text-sm font-semibold text-white transition-opacity disabled:opacity-60"
              >
