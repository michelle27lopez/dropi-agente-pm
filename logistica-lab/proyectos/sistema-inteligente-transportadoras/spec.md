...
| Capacidad/fuente absorbida | [PRM-1150](https://dropi-it.atlassian.net/browse/PRM-1150) "Información transportadoras en web" | En Ruta (backlog); historial confirma que fue **fusionada en PRM-203** el 20-mar-2026 |
...
> 4. **PRM-1150 no gobierna un proyecto aparte:** su historial dice `This work item merged into PRM-203`. Se conserva como antecedente de la información de carriers dentro del mismo frente. Comentario documental `51009` aplicado y releído en PRM-1219 el 03-ago-2026, sin cambiar estado, owner ni relaciones.
...
- Frontera de seguridad: la V1 debe enlazar **documentos curados para el usuario**, no la hoja operativa ni documentación con contratos, tarifas internas, credenciales, endpoints o datos crudos. GP/SOP-101 describen la integración de nuevos carriers y solo son una fuente adyacente. Auditoría: [archivos de transportadoras](auditoria-archivos-transportadoras-agosto-2026.md).

## 9 · Dependencias / acciones de JUAN (Carrier Operations)
- [ ] **Caracterización completa de transportadoras activas** para el catálogo (atributos §5). Insumo concreto = curar/estructurar los **4 docs de Drive** (recaudo / sin recaudo / trayectos especiales / métodos de pago e intentos) — con **Paula Macías**. Falta nombrar data owner, diccionario, sensibilidad, frecuencia/SLA y prueba de paridad; no retirar la fuente operativa antes de verificar el reemplazo.
...
## 11 · Changelog
- 2026-08-03 — **PRM-1150 reclasificado con evidencia exacta:** el historial confirma que fue fusionado en PRM-203; no es proyecto nuevo. Revisados PRM-1219/203 y GP/SOP/TO-BE de integración. Separados catálogo curado, fuente operativa, selección inteligente e integración de carriers. Comentario `51009` aplicado/releído en PRM-1219; auditoría detallada añadida sin copiar hoja ni datos sensibles.
