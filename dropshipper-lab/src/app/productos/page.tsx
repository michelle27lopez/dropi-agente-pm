  ...
  return (
    <div className="bg-white border border-zinc-200 rounded-xl overflow-hidden flex flex-col hover:shadow-lg transition-shadow cursor-pointer">
      ...
      <div className={`relative aspect-square flex-shrink-0 overflow-hidden bg-gradient-to-br ${p.bg}`}>
        ...
        {/* Extra label (e.g. "1 PERFUMERO") — top-right */}
        {p.extraLabel && (
        ...
        {/* Heart — bottom-right, rounded square */}
        <button
      ...
      {/* ── Info area — flex-1 so all cards stretch to same height ── */}
      <div className="p-3 flex flex-col flex-1">
        ...
        {/* Prices — pushed to bottom with mt-auto */}
        <div className="mt-auto space-y-3">
          ...
          {/* "Enviar a cliente" — text link style, border-t, no fill */}
          <button className="w-full flex items-center justify-center gap-2 pt-3 border-t border-zinc-100 text-dropi text-sm font-bold hover:opacity-75 transition-opacity">
...
export default function ProductosPage() {
  ...
  return (
    <div className="min-h-full pb-20">
      {/* ── AI Banner — rounded, with margin so corners are visible ── */}
      {bannerVisible && (
        <div className="px-5 pt-4">
          <div className="relative bg-gradient-to-r from-orange-700 via-orange-500 to-orange-400 rounded-xl overflow-hidden">
            {/* Decorative light layers simulating product images on right */}
            <div className="absolute right-0 top-0 bottom-0 w-1/2 bg-gradient-to-l from-orange-300/30 to-transparent" />
            <div className="absolute right-8 top-2 bottom-2 w-24 bg-white/5 rounded-lg backdrop-blur-[1px]" />
            ...
            <div className="relative px-8 py-5 flex items-center gap-10">
              ...
              <div className="text-white flex-shrink-0">
                <p className="text-sm font-medium opacity-95 mb-0.5">
                  Llega más rápido a tu producto ideal
                </p>
                <h2 className="text-[26px] font-black leading-tight tracking-tight">
                  La IA de dropi lo encuentra
                </h2>
              </div>

              {/* Search pill mockup */}
              <div className="flex-1 flex justify-center">
                <div className="bg-white/20 backdrop-blur-sm border border-white/50 rounded-full px-5 py-3 flex items-center gap-3 min-w-[280px] shadow-[0_0_20px_rgba(255,255,255,0.15)]">
      ...
      <div className="px-5 py-5 space-y-5">
        ...
        <div>
          ...
          {/* Cards clip to available width; arrow stays outside the overflow */}
          <div className="flex items-stretch gap-3">
            <div className="flex flex-1 gap-3 overflow-hidden">
              {providers.map((pv) => (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-full ${pv.bg} flex items-center justify-center flex-shrink-0`}
                  >
            ...
            {/* Arrow — outside the overflow clip, always visible */}
        ...
        <div>
          ...
          {/* Filter row 2: all dropdowns + apply in ONE row, no wrap */}
          <div className="flex items-end gap-2 overflow-x-auto pb-1">
            ...
            <div className="flex-shrink-0 space-y-1">
              ...
              <div className="flex items-center gap-1.5">
                <input
                  defaultValue="0"
                  className="w-16 border border-zinc-300 rounded-lg px-2.5 py-[7px] text-sm text-zinc-700 focus:outline-none focus:ring-1 focus:ring-dropi"
                />
                <span className="text-zinc-400 text-sm flex-shrink-0">—</span>
                <input
                  defaultValue="1.000.000"
                  className="w-24 border border-zinc-300 rounded-lg px-2.5 py-[7px] text-sm text-zinc-700 focus:outline-none focus:ring-1 focus:ring-dropi"
                />
              </div>
            </div>
          ...
          <div className="flex items-center gap-0.5">
            ...
            <button
              ...
              className={`p-1.5 rounded-md transition-colors ${
                view === "grid" ? "text-dropi bg-dropi-muted" : "text-zinc-400 hover:text-zinc-600"
              }`}
            >
            ...
            <button
              ...
              className={`p-1.5 rounded-md transition-colors ${
                view === "list" ? "text-dropi bg-dropi-muted" : "text-zinc-400 hover:text-zinc-600"
              }`}
            >
