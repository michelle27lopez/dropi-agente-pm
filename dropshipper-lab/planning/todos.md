...
- `[ ]` **PROD-1515:** Presionar y coordinar con Financiero la emisión de la DropiCard definitiva para Page Pilot (beta).
...
- `[ ]` **PROD-1519:** Finalizar especificaciones del plugin de WooCommerce (Alejandra Melo).
