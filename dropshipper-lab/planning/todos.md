# 📅 TODOS — Planificación Célula Seller Success (Q3 2026)

> Listado de tareas y pendientes de la célula, divididos por estado de ejecución.
...
- `[x]` **PROD-1376:** Realizar QA a las actualizaciones de Creador de Páginas (Bypasseado: se detectó bug en generación de landings, pero se decide avanzar ya que el reembolso por fallo es automático a la wallet).
- `[ ]` **PROD-580:** `[BLOQUEADO - DEPENDENCIA TECH]` [PRODUCTO][CIERRE] Dropify para Shopify - Pruebas aisladas PT2 (Módulos de Tokens, Sincronización Productos/Órdenes, Dashboard, Reglas).
...
- `[ ]` **PROD-1694:** Levantar el catálogo de eventos de notificaciones existentes en el backend (Alejandra Melo).
...
- `[ ]` **PROD-1359:** Evaluar si Academy mueve outcome (activación) o solo consumo/engagement (Discovery Q4).
- `[ ]` **PROD-1360:** Estudiar de sellers que activan rápido e identificar patrones comunes replicables.
...
- `[ ]` **PROD-1666:** [DISCOVERY Q4] Diagnóstico de churn y palancas de retención (Mapeo comercial 360, segmentación y rescate).
- `[ ]` **PROD-SEC-BEST:** [DISCOVERY Q4] Discovery continuo de Enrutamiento Dinámico (Second Best). Definir y validar supuestos más riesgosos (disposición al sobrecosto vs. cancelación) usando el mock con usuarios antes de pasar a estimaciones técnicas.
- `[ ]` **PROD-WRAPPED:** [DISCOVERY Q4] Darle forma conceptual en Discovery. Alejandra Melo definirá el diseño UX/UI y el alcance antes de planear el piloto. Ver [Opportunity Brief](file:///Users/santiago.herrera/Downloads/dropi-agente-pm/dropshipper-lab/planning/opportunity_brief_wrapped.md).
- `[ ]` **PROD-1352:** Medir cohorte inicial de supervivencia del seller post primera orden entregada.
