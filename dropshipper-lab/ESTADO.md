...
*   **Wrapped & Leyendas (Evento Septiembre):** Se unificó *Dropi Wrapped* con los 6 niveles del programa *Leyendas Dropi*. Ante la incertidumbre de desarrollo técnico masivo para el evento de septiembre, se procesó el archivo `resultado_JAAAAAIIIIIMMMMMMEEEEE2.csv` (10 sellers representativos) y se construyó la aplicación interactiva de Wrapped [dropi-wrapped-sellers.html](dropi-wrapped-sellers.html) con selector de seller, animaciones de nivel, drops acumulados, ventas COD en billones/millones, top producto y efectividad de entrega.
...
*   **PoolMax en Dropi (PoC Shopi):** Iniciativa estratégica aprobada por Lucho (CEO) y Maria (CPO) para distribución automática de ventas e inversión publicitaria vía API entre tiendas Shopi/Shopify. **Estado (2026-08-03):** Correo oficial enviado a Mónica González (Financial Manager), Nicolás Martínez (Financial Analyst) y Maria (CPO) bajo el asunto *"Prueba de Concepto Shopi (Distribución Automática de Ventas) – Explicación y Solicitud de Presupuesto"* solicitando asignación de presupuesto de pruebas y mecanismo de control financiero. Sesión de alineación con Arlex Rodríguez y el founder de la solución agendada para el Martes 4-Ago 3:00 PM.
