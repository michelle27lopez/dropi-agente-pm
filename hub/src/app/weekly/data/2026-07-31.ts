...
export const snapshot: WeeklySnapshot = {
  ...
  updateCelula: [
    {
      emoji: "🟢",
      nombre: "Dropi Pulso · PUL-001",
      estado: "Fase 1 en producción",
      hitos: [
        "🚀 Comercial reemplaza Nexus con la plataforma — operación diaria ya corre sobre Pulso",
        "✅ Señal de stock automática activa: cuando un producto cruza a Alta (≤5 días) con campaña activa, la señal se crea sola — sin paso manual",
        "✅ Un solo update de stock recalcula la prioridad de todos los dropshippers que cuidan ese producto",
        "📊 Estimado con Comercial: 8.000 → 40.000 órdenes/mes solo desde cuidado de campañas",
      ],
      accionables: [
        "Confirmar con Reinoso si el mantenimiento de BD ya terminó — prerequisito del endpoint de data real (semana 04-ago)",
        "Semana 04-ago: inicio manual con Pareto de Iván Caicedo (30 providers aliados) + Pareto de dropshippers de Comercial (535 usuarios)",
        "Seguimiento con Natalia — reunión cortada por internet, reagendar",
      ],
      novedad: "🌟 La automatización de Pulso recalcula toda la red de dropshippers de un proveedor en un solo evento de stock — escala sin esfuerzo manual",
    },
    {
      emoji: "🟡",
      nombre: "TTV-001 · Activación de Suppliers",
      estado: "Dashboard live · Pivot decidido · Agente WA semana 04-ago",
      hitos: [
        "✅ Enrique entregó el dashboard de activación en Metabase (en vivo): 97 con activación bruta (TTFO), 18 con activación neta (TTV real)",
        "🔍 La brecha 97→18 es el punto exacto de fuga: proveedores que crean una orden pero no la completan",
        "🔍 Plan de choque Fast Track (10 llamadas) no funcionó — formulario de entrada no confiable: los providers declaran volumen que en realidad no tienen",
      ],
      accionables: [
        "Semana 04-ago: implementar agente WA que filtre por comportamiento real (no por lo declarado) antes del contacto humano",
        "Redefinir criterios de scoring del pipeline GHL — los datos de entrada actuales están contaminados",
        "Solo los providers que el agente califique con señal real reciben llamada del equipo",
      ],
      novedad: "💡 El agente WA pasa a ser el filtro de calidad antes del toque humano — no solo automatización de onboarding",
    },
    {
      emoji: "🟡",
      nombre: "Cyber Days · T-11 · DESC-001 + DCA-001",
      estado: "T-11 días · DCA-001 listo · Handoff DESC-001 pendiente",
      hitos: [
        "✅ Sistema DCA-001 listo: frames automáticos ZIP, catálogo Canva, categoría CyberDays, popup UserPilot confirmado por Laura",
        "⚡ José confirmó handoff de DESC-001 esta semana — hay que agendarlo hoy, cada día cuenta",
        "🗂️ Majo tiene assets gráficos en progreso",
      ],
      accionables: [
        "Agendar handoff DESC-001 con José hoy (acordado lunes) — T-11 sin fecha técnica aún",
        "Meet kick-off con suppliers: viernes 1-ago",
        "Email instrucciones + Canva: 3-ago · Cierre carga: 9-ago · Lanzamiento: 11-ago",
        "Confirmar con Lucho etiquetas en Dropy y con Majo estado de assets",
      ],
      novedad: "🛍️ Cada día sin handoff es un día menos de ventana técnica para Cyber Days",
    },
    {
      emoji: "🟢",
      nombre: "ESP-001 · Radar de Comunidad",
      estado: "Fase 1 live · 693 msgs reales confirmados",
      hitos: [
        "✅ Datos reales desde Supabase al 30-jul: 693 mensajes en 10 días (21-30 jul), 2 grupos, 157 personas únicas",
        "🔍 Tema #1 real (no el preliminar): Bugs y fricciones de plataforma (102 hits) — pedidos duplicados, stock fantasma, reportes que no cargan",
        "🔍 Transportadoras queda #2 (79 hits). Lucho (CEO) es el 3er mayor emisor del Grupo B con 12 mensajes propios resolviendo tickets",
        "✅ Búsqueda por tema funciona: cualquier miembro del equipo busca 'qué dicen sobre X' sin leer el chat",
      ],
      accionables: [
        "Definir con Kate/Laura/Majo el ritmo de clasificación semanal — quién lo hace, qué día",
        "Definir qué grupos de Facebook/YouTube entran a Fase 2",
        "Hablar con Brands y Logística: qué grupos escucharían y qué vista necesitan",
        "Solicitar WA dedicado para el área (hoy usa el WA de Mit)",
      ],
      novedad: "🌟 Bugs/plataforma (no transportadoras) es el tema #1 real — la clasificación manual de 3 días daba una foto incompleta",
    },
    {
      emoji: "🟡",
      nombre: "CAT-001 · Categorías de Producto",
      estado: "Pitch el jueves con María · Desbloquea 3 iniciativas",
      hitos: [
        "🔍 José confirmó: el bug de CAZ-001 (Caza Productos) no se puede resolver sin revisar el árbol de categorías primero",
        "🔍 Valentina tiene 111K IDs de producto sin estandarizar — no puede hacer proyecciones de temporada en Pulso",
        "🔍 El motor de alertas de concentración de Pulso tampoco opera sin IDs estandarizados",
        "✅ Demo con Lucho fue positiva la semana pasada",
      ],
      accionables: [
        "Jueves: pitch de 5 minutos con María conectando los 3 casos (CAZ-001 bug + proyecciones Valentina + alertas Pulso)",
        "Pregunta concreta para María: '¿Cuándo y quién puede asignarse a CAT-001?'",
        "IND-001: esperar visto bueno de María con Legal — en cuanto llegue, activar 208 candidatos a Verificado",
      ],
      novedad: "🎯 Un solo unlock técnico destraba tres iniciativas distintas — el argumento de priorización es el más fuerte que hemos tenido",
    },
    {
      emoji: "🔴",
      nombre: "NEG-001 · Carga Masiva · COM-001 Combos",
      estado: "Sin fecha · Piloto GGP bloqueado indefinidamente",
      hitos: [
        "😢 José confirmó: la carga masiva no va a salir como feature aislado — espera la nueva versión completa de Negociaciones (sin fecha, sin recursos)",
        "😢 Piloto GGP Comercializadora (10K+ productos) sigue bloqueado — Emilille lleva semanas esperando esta funcionalidad",
        "🔴 COM-001 Combos en cola — revisarán recursos cuando salgan de Negociaciones",
      ],
      accionables: [
        "Comunicar a Emilille hoy el cambio de plan — el workaround disponible es el ticket STID-6257 (manual)",
        "NEG-002 (Negociaciones Supplier↔Dropshipper): agendar reunión con Juan Diego (PM anterior) — prerequisito del discovery formal",
      ],
      novedad: "📌 NEG-002 está aprobada — hay que arrancar discovery esta semana, no esperar más a NEG-001",
    },
  ],
