          ...
          <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px", display: "flex", alignItems: "center", gap: 16 }}>
            <Breadcrumb
              items={[
                ...
                { label: "Descuentos en Catálogo" },
              ]}
            />
            <a
              href="/proyectos/descuentos/discovery"
              style={{
                marginLeft: "auto",
                display: "inline-flex",
                alignItems: "center",
          ...
          {docsOpen && (
            <div style={{
              ...
              {[
                ...
                {
                  href: `${RPP_BASE_URL}/new/productos/mis-productos?profile=proveedor`,
                  icon: "🚀",
                  title: "Rapid Prototype · Descuento (Proveedor)",
                  sub: "Mis productos → Editar → pestaña Descuento. Requiere ng serve corriendo en dropi-prototypes.",
                  badge: "Nuevo",
                  badgeColor: "#7C3AED",
                  external: true,
                },
                {
                  href: `${RPP_BASE_URL}/new/productos/catalogo?profile=dropshipper`,
                  icon: "🚀",
                  title: "Rapid Prototype · Catálogo (Dropshipper)",
                  sub: "Catálogo y Detalle con precio antes/ahora. Requiere ng serve corriendo en dropi-prototypes.",
                  badge: "Nuevo",
                  badgeColor: "#7C3AED",
                  external: true,
                },
