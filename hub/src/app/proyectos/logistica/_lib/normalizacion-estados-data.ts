...
export const flowNodes: FlowNode[] = [
  ...
  { id: "pickup-pending", label: "Pendiente de recolección", short: "Pendiente recolección", x: 540, y: 70, tone: "warning", kind: "main", modes: ["directo", "dropi"], phase: "Recolección", actor: "Carrier o Dropi", client: "En preparación", detail: "Permite medir cuánto tarda la recogida antes del handoff.", flags: ["No movilizado", "Reintento posible"] },
  { id: "received", label: "Recibido por transportadora", short: "Recibido carrier", x: 780, y: 70, tone: "carrier", kind: "main", modes: allRoutes, phase: "Transporte", actor: "Transportadora", client: "En camino", detail: "Frontera de movilización: el carrier ya tiene el paquete.", flags: ["Movilizado", "Salió de bodega"] },
  ...
  { id: "prepared", label: "Preparado para transportadora", short: "Preparado ECOM", x: 450, y: 205, tone: "ecom", kind: "optional", modes: ["ecom", "dropi"], phase: "ECOM", actor: "Proveedor", client: "En preparación", detail: "ECOM registra que el pedido está listo para salir.", flags: ["No movilizado", "En bodega"] },
  { id: "ecom-handoff", label: "Entregado a transportadora", short: "Handoff ECOM", x: 630, y: 205, tone: "ecom", kind: "optional", modes: ["ecom", "dropi"], phase: "ECOM", actor: "Proveedor / ECOM", client: "En camino", detail: "El nombre suena a preparación, pero implica salida física de bodega.", flags: ["Salida de bodega", "Flag contable crítico"] },
  { id: "dropi-pickup", label: "Recolectado por Dropi", short: "Recolectado Dropi", x: 570, y: 335, tone: "dropi", kind: "optional", modes: ["dropi"], phase: "Dropi", actor: "Operación Dropi", client: "En camino", detail: "Dropi recoge el paquete antes de entregarlo al carrier.", flags: ["Movilizado interno", "Salió de bodega"] },
  ...
  { id: "pickup-retry", label: "Reintento de recolección", short: "Reintento recogida", x: 680, y: 485, tone: "warning", kind: "exception", modes: ["directo", "dropi"], phase: "Recolección", actor: "Operación", client: "En preparación", detail: "Nuevo intento antes de declarar la orden sin movilización.", flags: ["No movilizado", "Contador por cerrar"] },
  ...
  { id: "returned", label: "Devolución confirmada", short: "Devolución cerrada", x: 1360, y: 500, tone: "return", kind: "terminal", modes: allRoutes, phase: "Devolución", actor: "Bodega / proveedor", client: "Proceso finalizado", detail: "El cierre ocurre cuando bodega confirma la recepción física.", flags: ["Terminal", "Libera stock"] },
...
export const guideExamples: GuideExample[] = [
  { id: "240028451950", carrier: "INTERRAPIDISIMO", outcome: "Devolución", highlight: "Proceso finalizado no fue terminal", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recibido transportadora", "En tránsito", "En reparto", "Proceso finalizado", "Cancelado", "Devolución"] },
  { id: "240028493814", carrier: "INTERRAPIDISIMO", outcome: "Devolución", highlight: "Novedad termina en devolución", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "Devolución"] },
  { id: "36393180723", carrier: "COORDINADORA", outcome: "Entregado", highlight: "Novedades y reintentos recuperan la entrega", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "En reparto", "Novedad solucionada", "En reparto", "Entregado"] },
  { id: "36393170971", carrier: "COORDINADORA", outcome: "Devolución", highlight: "Usa recolección Dropi", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recolectado por Dropi", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "Devolución"] },
  { id: "36393170001", carrier: "COORDINADORA", outcome: "Devolución", highlight: "Dos novedades solucionadas no evitaron devolución", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "Novedad solucionada", "En reparto", "Novedad", "Novedad solucionada", "Devolución"] },
  { id: "114014276600", carrier: "ENVIA", outcome: "Devolución", highlight: "Tres ciclos novedad-solución", steps: ["Pendiente", "Guía generada", "En preparación", "En tránsito", "En reparto", "Novedad", "Novedad solucionada", "En reparto", "Novedad", "Novedad solucionada", "Novedad", "Novedad solucionada", "Devolución"] },
  { id: "024029789992", carrier: "ENVIA", outcome: "Devolución", highlight: "Dropi + carrier + novedad", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recolectado por Dropi", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "Novedad solucionada", "Devolución"] },
  { id: "3864790571", carrier: "99MINUTOS", outcome: "Devolución", highlight: "Ruta ECOM + Dropi completa", steps: ["Pendiente", "Guía generada", "En preparación", "Recolectado por Dropi", "En bodega Dropi", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "Devolución en proceso", "Devolución"] },
  { id: "1222059299", carrier: "99MINUTOS", outcome: "Devolución", highlight: "Dos intentos antes de devolución", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "En preparación", "Recolectado por Dropi", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "En reparto", "Novedad", "Devolución"] },
  { id: "V4001044476", carrier: "VELOCES", outcome: "Devolución", highlight: "Tres novedades antes del retorno", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recolectado por Dropi", "En bodega Dropi", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "En reparto", "Novedad", "Novedad", "Devolución en proceso", "Devolución"] },
  { id: "V4001043459", carrier: "VELOCES", outcome: "Entregado", highlight: "Entregado rebotó a reparto", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recolectado por Dropi", "En bodega Dropi", "Recibido transportadora", "En tránsito", "Entregado", "En reparto", "Entregado"] },
  { id: "40546381", carrier: "DOMINA", outcome: "Devolución", highlight: "Orden irregular entre carrier y Dropi", steps: ["Pendiente", "Guía generada", "En preparación", "Recibido transportadora", "Recolectado por Dropi", "En bodega Dropi", "En reparto", "Novedad", "Novedad solucionada", "Devolución"] },
  { id: "85910403203823", carrier: "DOMINA", outcome: "Entregado", highlight: "Novedad recuperada", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "En preparación", "En bodega Dropi", "Recibido transportadora", "En tránsito", "En reparto", "Novedad", "En reparto", "Entregado"] },
  { id: "9641616116781858", carrier: "FUTURA", outcome: "Devolución", highlight: "Reparto y tránsito alternan varias veces", steps: ["Pendiente confirmación", "Pendiente", "Guía generada", "Recolectado por Dropi", "Recibido transportadora", "En tránsito", "En reparto", "En tránsito", "En reparto", "En tránsito", "Devolución"] },
];
...
export const routeLabels: Record<RouteMode, { label: string; detail: string }> = {
  directo: { label: "Directo", detail: "Proveedor entrega al carrier; salta ECOM y Dropi" },
  ecom: { label: "ECOM", detail: "Preparación ECOM y entrega directa al carrier" },
  dropi: { label: "ECOM + Dropi", detail: "ECOM obligatorio y recolección operada por Dropi" },
};
