...
export const weeklies: Weekly[] = [
  ...
  // ── Semana 18 – 22 ago 2026 · POCs LOG-019 / LOG-020 (aporte de Michel Pino, PR #204) ──
  // Misma semana ISO que el w34 consolidado de arriba, pero desde el ángulo de
  // los dos POCs entregados a la célula. Se conserva como entrada aparte
  // (id "2026-w34-pocs") para no perder el detalle de Autoconfirmación ×
  // ChateaPro y Servicios en Bodega. `comparacionMensual` migrada al formato
  // meses[]/valores[] que ya usa el resto del archivo.
  {
    id: "2026-w34-pocs",
    fecha: "Viernes 22 de agosto de 2026",
    semana: "Semana 18 – 22 ago · POCs",
    foco:
