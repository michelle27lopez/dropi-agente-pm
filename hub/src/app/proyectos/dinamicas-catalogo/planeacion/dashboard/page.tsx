...
export default function PlaneacionPortfolioDashboardPage() {
  ...
  if (loading) {
    return <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100vh", color: "var(--muted)", fontSize: 14 }}>Cargando dashboard general...</div>;
  }
  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)" }}>
      <header style={{
        ...
        <a href="/proyectos/dinamicas-catalogo/planeacion" style={{ fontSize: 13, color: "var(--muted)", textDecoration: "none" }}>Planeación</a>
        <span style={{ color: "var(--border)" }}>/</span>
        <span style={{ fontSize: 13, color: "var(--fg)", fontWeight: 600 }}>Dashboard general</span>
      </header>
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <p style={{ fontSize: 14, color: "var(--muted)", marginBottom: 28, maxWidth: 620, lineHeight: 1.6 }}>
          Compara los resultados reales de todas las campañas de Planeación que ya tienen datos cargados en el nodo Resultados.
        </p>
          ...
          <div style={{ marginTop: 28 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {withoutResults.map((c) => (
                <span key={c.id} onClick={() => router.push(`/proyectos/dinamicas-catalogo/planeacion/${c.id}`)}
