  ...
  // ── Nodo 1: Ficha base ─────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        required: true,
        options: ["Producto", "Growth", "Comercial", "Brands Success", "Comunicaciones"],
      },
      {
        key: "objective",
  ...
  // ── Nodo 3: Segmento y elegibilidad ───────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        required: true,
        options: ["Brands Success", "Comercial", "Producto", "Growth", "Líder de campaña"],
      },
    ],
  },
  ...
  // ── Nodo 5: Convocatoria supplier ──────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        required: true,
        options: ["Comercial", "Growth", "Comunicaciones", "Brands Success", "Producto", "Líder de campaña"],
      },
      {
        key: "supplier_list",
    ...
    fields: [
      {
        ...
        options: [
          ...
          "Formulario GHL",
          "Selección interna por Brands Success",
          "Tally",
        ],
        optionDescriptions: {
          ...
          "Selección interna por Brands Success": "El equipo selecciona productos sin postulación abierta al supplier.",
  ...
  // ── Nodo 7: Vitrina ────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        required: true,
        options: ["Producto", "Growth", "Comercial", "Comunicaciones", "Brands Success", "Diseño"],
      },
    ],
  },
  ...
  // ── Nodo 8: Handoff final ──────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "multiselect",
        required: true,
        options: ["Producto", "Growth", "Comercial", "Brands Success", "Comunicaciones", "Diseño", "María Ossa", "Lucho"],
      },
      {
        key: "schedule",
