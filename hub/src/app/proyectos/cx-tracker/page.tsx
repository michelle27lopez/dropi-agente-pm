...
// ── Seed real — proyectos de la Célula Experience ───────────────────────────
// Métricas de UX (adopción/retención/CES/CSAT) sin medir todavía → en blanco.
// Lo cualitativo (objetivo, hallazgos, bugs, próximos pasos) viene del Weekly
// Status real de cada proyecto (semana del 31 ago–4 sep 2026).
const PROJECTS_SEED: ProjectEntry[] = [
  {
    ...
    m1: [{
      ...
      objetivo: "Reorganizar la navegación y pantallas de Dropi por módulo, sin alterar la lógica de negocio.",
      usuarios: { perfil: "Dropshipper", perfilOtro: "", cantidad: "", notas: "Dropshippers, Proveedores y Marcas — todos los países" },
      hallazgos: "Frente 1: 66 corregidos / 9 pendientes (1 crítico). Frente 2: 64 corregidos / 7 pendientes (1 crítico). Total consolidado: 130 corregidos / 16 pendientes.",
      dolores: "2 bugs críticos pendientes (1 por frente) antes de poder cerrar QA.",
      bugs: [
        { id: "b1", tipo: "QA · Frente 1", desc: "1 bug crítico pendiente de corrección.", status: "proceso" },
        { id: "b2", tipo: "QA · Frente 2", desc: "1 bug crítico pendiente de corrección.", status: "proceso" },
      ],
      proximosPasos: "🔵 Ejecutar la fase de pruebas la próxima semana.",
    }],
    m2: [], m3: [],
  },
  {
    ...
    m1: [{
      ...emptyRow(),
      fecha: "31 de Agosto, 2026",
      objetivo: "MVP Órdenes 2.0 — importación, exportación, etiquetas y optimización de creación manual de órdenes.",
      usuarios: { perfil: "Dropshipper", perfilOtro: "", cantidad: "6000", notas: "Usuarios activos diarios del módulo de órdenes" },
      dolores: "Bloqueado por falta de asignación de un desarrollador.",
      proximosPasos: "⛔ Bloqueado — pendiente asignación de desarrollador. Se realizará un research con proveedores para validar las funcionalidades que quieren ver en el módulo.",
    }],
    m2: [], m3: [],
  },
  {
    ...
    m1: [{
      ...emptyRow(),
      fecha: "31 de Agosto, 2026",
      objetivo: "Gestión de Novedades: implementación y centralización de la gestión de novedades para optimizar la operativa inicial.",
      usuarios: { perfil: "Dropshipper", perfilOtro: "", cantidad: "", notas: "Usuarios de la Dropi App" },
      hallazgos: "Pruebas activas por el equipo de Tecnología, pruebas en curso con Coordinadora (última fase para liberación) y pruebas internas habilitadas en TestFlight.",
      proximosPasos: "🔵 Continuar seguimiento de QA hasta liberación.",
    }],
    m2: [], m3: [],
  },
  {
    ...
    m1: [{
      ...emptyRow(),
      fecha: "31 de Agosto, 2026",
      objetivo: "Dashboard de indicadores centralizado para Proveedor, Marca y Marca Blanca — centro de mando al iniciar sesión.",
      usuarios: { perfil: "Proveedor", perfilOtro: "", cantidad: "", notas: "Proveedor, Marca y Marca Blanca — Colombia" },
      hallazgos: "En piloto beta desde noviembre de 2025. Lanzamiento general posible: 8 de septiembre de 2026 (sujeto a confirmación).",
      proximosPasos: "🔵 Confirmar fecha de lanzamiento general con el equipo.",
    }],
    m2: [], m3: [],
  },
  {
    ...
    m1: [{
      ...emptyRow(),
      fecha: "31 de Agosto, 2026",
      objetivo: "MVP para capturar usuarios interesados en ser testers de Dropi, de cara a ExpoWinner.",
      dolores: "Bloqueado por falta de desarrollador asignado. Proyecto despriorizado frente a Rearquitectura, Órdenes y Dropi App.",
      proximosPasos: "⛔ Bloqueado — sin desarrollador asignado.",
    }],
    m2: [], m3: [],
  },
  {
    ...
    m1: [{
      ...emptyRow(),
      fecha: "31 de Agosto, 2026",
      objetivo: "Escuchar la voz de los usuarios integrando fuentes de datos alternas al ecosistema Dropi.",
      hallazgos: "Reunión con Servicio al Cliente — acuerdo de integración de datos desde Intercom. En construcción un universo de datos alternos (redes sociales, comunidades y chat de Academy).",
      proximosPasos: "🔵 Confirmar las integraciones (Intercom, redes sociales, comunidades, chat de Academy) y rediseñar la interfaz para una correcta segmentación de la información.",
    }],
    m2: [], m3: [],
  },
];
