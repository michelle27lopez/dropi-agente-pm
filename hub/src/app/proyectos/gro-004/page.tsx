...
const links = [
  { label: "Documento de traspaso técnico", href: "https://claude.ai/code/artifact/e27b2d8c-be66-4e0a-8783-2417e4268b44", icon: FileText, desc: "11 secciones: kick-off, las 3 superficies, arquitectura de escala, GEO/AEO, insumos de datos, narrativa, 7 historias de usuario con QA." },
];
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={badgeStyle("#0E7C74", "#E3F3F0")}>Fuente: documento de traspaso, agosto 2026</span>
                </div>
