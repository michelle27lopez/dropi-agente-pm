    ...
    <div style={{ background: "#F8FAFC", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ maxWidth: 1200, width: "100%", margin: "0 auto", padding: "24px 20px", flex: 1 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
                ...
                <span style={badgeStyle("#B45309", "#FEF3C7")}>🧪 POC · Activo (extendido)</span>
              ...
              <p style={{ fontSize: 14, color: "#475569", margin: "6px 0 0 0" }}>
                Modal experimental en UserPilot para dar visibilidad a un flujo de retiro USDT que ya existía en Dropi pero era prácticamente invisible en la experiencia. Piloto 27-jul → 13-ago 2026, Colombia.
              </p>
            </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(190px, 1fr))", gap: 16, marginBottom: 28 }}>
          <KPI label="Expuestos al modal" value="8.060" sub="Datos Bancarios · Colombia · 18 días" color="#3B82F6" icon={<Users size={18} />} />
          <KPI label="Clic en CTA" value="6,55%" sub="528 usuarios agregaron cuenta USDT" color="#8B5CF6" icon={<MousePointerClick size={18} />} />
          <KPI label="Retiros nuevos atribuibles" value="0,09%" sub="7 de 8.060 expuestos (30 días)" color="#EF4444" icon={<TrendingDown size={18} />} />
          ...
          <KPI label="Volumen USDT (abr → jul)" value="523K → 1,95M" sub="Crecimiento orgánico previo al experimento" color="#10B981" icon={<TrendingUp size={18} />} />
        </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={badgeStyle("#4338CA", "#E0E7FF")}>Fuente: POC_Masificacion_USDT.md</span>
                </div>
                <p style={{ fontSize: 13, color: "#475569", margin: "2px 0 0 0" }}>
                  Reporte de POC — contexto, discovery, resultados del piloto y decisión de extenderlo.
                </p>
              </div>
            </div>
                  ...
                  <div style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 12, padding: 20 }}>
                    ...
                    <div style={{ background: "#F8FAFC", borderRadius: 10, padding: 16, marginBottom: 20, border: "1px solid #E2E8F0" }}>
                      <table style={{ width: "100%", borderCollapse: "collapse" }}>
                        ...
                        <tbody>
                          ...
                          <tr><td style={tableCellStyle}><strong>Estado</strong></td><td style={tableCellStyle}>POC — Activo (extendido)</td></tr>
                          ...
                          <tr><td style={tableCellStyle}><strong>Período del piloto</strong></td><td style={tableCellStyle}>27 de julio – 13 de agosto, 2026</td></tr>
                        </tbody>
                      </table>
                    </div>
                    ...
                    <div style={{ background: "#FFFBEB", border: "1px solid #FDE68A", padding: 14, borderRadius: 10, marginBottom: 20 }}>
                      ...
                      <p style={{ fontSize: 12, color: "#78350F", margin: "6px 0 0 0", lineHeight: 1.5 }}>
                        El experimento se diseñó originalmente con modal + banner, pero el banner presentó problemas de configuración en UserPilot y se descartó de la implementación final. El piloto corrió únicamente con el componente modal. Los resultados reportados corresponden exclusivamente a <strong>Colombia</strong>.
                      </p>
                    </div>
                  ...
                  <div style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 12, padding: 20 }}>
                    ...
                    <div style={{ background: "#EFF6FF", border: "1px solid #93C5FD", borderRadius: 10, padding: 16 }}>
                      ...
                      <p style={{ fontSize: 12, color: "#1E3A8A", margin: 0 }}>
                        Métrica de éxito definida (estándar interno sin data previa): <strong>25% de conversión de exposición a acción.</strong>
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 12, padding: 20 }}>
                    ...
                    <div style={{ background: "#EFF6FF", border: "1px solid #93C5FD", borderRadius: 10, padding: 14, marginBottom: 24 }}>
                      <p style={{ fontSize: 12, color: "#1E3A8A", margin: 0, lineHeight: 1.6 }}>
                        <strong>Lectura:</strong> el volumen real de tráfico a ambos módulos en Ecuador, Chile y México es considerablemente mayor al que el experimento logró exponer bajo el filtro de 90 días. Esto respalda la hipótesis de que la baja exposición del experimento en esos países es un problema de configuración de alcance, no de falta de tráfico — hay usuarios suficientes, pero la mayoría de sus cuentas no supera aún los 90 días de antigüedad por ser mercados de apertura más reciente.
                      </p>
                    </div>

                    <h4 style={{ fontSize: 14, fontWeight: 800, color: "#0F172A" }}>Resultados del piloto — Datos Bancarios · Colombia · 18 días</h4>
                ...
                {activeTab === "insights" && (
                  <div style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 12, padding: 20 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                      {[
                        { n: 1, title: "El modal genera awareness pero no basta para convertir.", desc: "La conversión de clic a retiro efectivo (3,98%) confirma que existe una ruptura entre \"conocer la opción\" y \"usarla\" — el embudo completo (clic → cuenta configurada → retiro) no está cerrado; falta instrumentar el paso intermedio de configuración de cuenta." },
                        { n: 2, title: "El crecimiento de negocio observado no es atribuible al experimento.", desc: "El volumen de retiros USDT venía en crecimiento orgánico desde abril; los datos no permiten conectar el +24% de Colombia con el experimento de forma causal." },
                        { n: 3, title: "El segmento que más convierte no es el que se priorizó en el discovery inicial.", desc: "Los dropshippers superan a los suppliers en conversión, abriendo una línea de investigación cualitativa no contemplada originalmente." },
                        { n: 4, title: "La baja exposición en mercados nuevos es un problema de alcance, no de mensaje.", desc: "El filtro de 90 días deja fuera a la mayoría de usuarios en Ecuador, México, Chile y Perú, mercados de apertura más reciente." },
                        { n: 5, title: "La limitación mobile de UserPilot deja fuera un canal relevante.", desc: "Cualquier estrategia de comunicación masiva (ej. WhatsApp) no puede garantizar que el usuario complete el flujo desde su celular." },
                      ].map((item) => (
                ...
                {activeTab === "decision" && (
                  <div style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 12, padding: 20 }}>
                    ...
                    <div style={{ background: "#ECFDF5", border: "1px solid #6EE7B7", borderRadius: 10, padding: 16, marginBottom: 16 }}>
                      <strong style={{ fontSize: 13, color: "#065F46" }}>Decisión: Extender el piloto, no cerrar ni reemplazar.</strong>
                      <p style={{ fontSize: 12, color: "#065F46", margin: "6px 0 0 0", lineHeight: 1.6 }}>
                        Existen dos variables no medidas — cuentas USDT configuradas y cumplimiento del ciclo natural de retiro (20 días a 2 meses según ciclos de importación) — que pueden cambiar la lectura del resultado.
                      </p>
                    </div>
                    ...
                    <ul style={{ fontSize: 13, color: "#334155", lineHeight: 1.7, paddingLeft: 20, marginBottom: 20 }}>
                      ...
                      <li>Cerrar la medición del embudo (cuentas USDT agregadas).</li>
                      <li>Activar estrategia de lanzamiento ampliada (tutorial embebido, guía rápida permanente, contenido en redes) propuesta por UserPilot para atacar el 91,8% de dismissed.</li>
                      <li>A/B testing de una variable a la vez: primero reducir filtro de antigüedad de cuenta — el tráfico real disponible en Ecuador, Chile y México lo justifica —, luego simplificar copy manteniendo disclaimers legales.</li>
                    ...
                    <PendingNote>
                      Aún faltan por enlazar: dashboards de seguimiento UserPilot y reporte final de resultados (27 jul – 13 ago).
                    </PendingNote>
                  </div>
                )}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#94A3B8", marginBottom: 24 }}>
          <Layers size={14} />
          <span>Contenido cargado desde POC_Masificacion_USDT.md · Última sincronización: <Clock size={12} style={{ verticalAlign: "middle" }} /> 18/08/2026</span>
        </div>
      </main>
