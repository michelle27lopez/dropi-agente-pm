...
const EVIDENCIA: { tema: string; href: string; nivel: "Sólida" | "Parcial" | "Débil"; color: string; base: string }[] = [
  ...
  {
    tema: "Satisfacción",
    href: "/guias/proveedores/satisfaccion",
    nivel: "Parcial",
    color: "var(--warning)",
  ...
  },
  {
    ...
    href: "/guias/proveedores/funcionalidades",
    nivel: "Parcial",
    color: "var(--warning)",
  ...
  {
    tema: "Onboarding",
    href: "/guias/proveedores/onboarding",
    nivel: "Parcial",
    color: "var(--warning)",
  ...
  {
    tema: "Herramientas",
    href: "/guias/proveedores/herramientas",
    nivel: "Sólida",
    color: "var(--success)",
